...
Git should be installed on your Linux accounts. If you'd like to work on your assignments on your own computer at home, install Git by following the steps below.
...
## Lab 1.1: Using Git & GitHub

1. Create a [GitHub](https://www.github.com/) account under your school email address (if you haven't already).

2. Visit https://education.github.com/pack. Click 'Get your pack' and follow the instructions to request a discounted plan. With student accounts, you'll be able to host up to 5 private repositories on your GitHub account, which is normally a paid feature.

3. Follow the steps in this introductory [tutorial](https://product.hubspot.com/blog/git-and-github-tutorial-for-beginners) to get to some hands-on experience with Git and GitHub.

4. Create a new GitHub repository named `csc59940`. Make it public and check 'Initialize this repository with a README'. Later, once your discount requests are processed, we'll switch the repository over to private mode.

5. Follow the instructions [here](https://help.github.com/articles/inviting-collaborators-to-a-personal-repository/) to add us as collaborators on your repository. David's username is `dmoon1221`, Michelle's is `michelleshu`.

6. Open a terminal and create a local copy of your `csc59940` GitHub repository by running
    ```
