...
Components are a way to structure your UI into composable and reusable pieces. In practice, we choose to use components over what we did with the clock element above. This is largely because a React element will let us turn this:
